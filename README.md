# BadWeatherBot - [@BadWeatherBot](https://t.me/badweatherbot)
...
<img src="./img/umbrella command.jpg" width="40%"><img src="./img/umbrella command (rain).jpg" width="40%">
<img src="./img/washingmachine command.jpg" width="40%">
